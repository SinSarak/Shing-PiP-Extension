...
(() => {
  ...
  function n() {
    let n = Array.from(document.querySelectorAll("video"))
      ...
      .sort((n, e) => {
        let t = n.getClientRects()[0] || { width: 0, height: 0 },
          o = e.getClientRects()[0] || { width: 0, height: 0 };
        return o.width * o.height - t.width * t.height;
      });
  ...
  function t(t, o) {
    let i = t[0].target;
    if (!document.querySelector("[__pip__]")) return void o.unobserve(i);
    let r = n();
    r && !r.hasAttribute("__pip__") && (o.unobserve(i), e(r));
  }
  !(function () {
    var t = {
        944: (n) => {
          const e = Object.freeze({ YT: 0, NT: 1, DS: 2, PRV: 3 });
          let t = null;
          function o() {
          ...
          n.exports = {
            ...
            enterPiPHandler: function (n, i) {
              ...
              if (r === e.YT) {
                ...
                let n = document.querySelector(".player-timedtext");
                n && i.append(n);
              } else if (r === e.DS) {
            ...
            exitPiPHandler: function (n) {
              let i = o();
              if (i === e.YT) {
                let e = document.querySelector(".html5-video-player"),
                  t = n.target.querySelector(".ytp-caption-window-container");
                t && e.append(t);
              } else if (i === e.NT) {
                let e = n.target.querySelector(".player-timedtext");
                e &&
                  document
                    .querySelector('[data-uia="video-canvas"]')
                    .children[0].children[0].append(e);
              } else if (i === e.DS) {
                let e = n.target.querySelector(".dss-hls-subtitle-overlay");
    ...
    (() => {
      ...
      let o,
        ...
        a = null;
      function s(n, e) {
        n && (n.innerHTML = escapeHTMLPolicy.createHTML(e));
      }
      function c(n) {
        return n.document.querySelector("video");
      }
      function p(n) {
        const e = c(n);
      ...
      function C(n) {
        let e = n.value + "%";
        n.style.setProperty("--litters-range", e);
      }
      function g(n) {
        return document.body.hasAttribute("data-duration")
      ...
      function m(n, e, t) {
        ...
        n.document.querySelector("#pipController") ||
          ...
          n.document
            ...
            .addEventListener("click", () => {
              d()
                ...
                : (function (n) {
                    const e = c(n);
                    e && (e.currentTime = e.currentTime - 10);
                  })(n);
            }),
          n.document
            .querySelector('button[data-action="forward"]')
            .addEventListener("click", () => {
              d()
                ? (function (n) {
                    c(n) && u(10);
          ...
          n.document
            ...
            .addEventListener("click", () => {
              !(function () {
                let n = document.querySelector(".ytp-next-button.ytp-button");
                n && n.click();
              })();
            }),
          n.document
          ...
          n.document
            .querySelector('button[data-action="crop"]')
            .addEventListener("click", () => {
              !(function (n) {
                if (
                  (n = documentPictureInPicture.window).innerWidth * o >
                  n.innerHeight * r
                ) {
                  let e = Math.floor((n.innerHeight * r) / o + 0.5),
                    t = n.innerWidth;
                  n.resizeBy(e - t, 0);
          ...
          n.document
            .querySelector("#pipProgress")
            .addEventListener("input", (e) => {
              let t = parseFloat(e.target.value) / 100;
              d()
                ? (function (n, e) {
                    const t = c(n);
                    t &&
                ...
                : (function (n, e) {
                    const t = c(n);
                    t && (t.currentTime = Math.floor(g(t) * e + 0.5));
                  })(n, t);
            }),
      ...
      ((escapeHTMLPolicy = trustedTypes.createPolicy("forceInner", {
        ...
        (async function () {
          if (documentPictureInPicture.window)
            ...
            const i = (function () {
              const n = Array.from(document.querySelectorAll("video"))
                .filter((n) => 0 != n.readyState)
                .sort((n, e) => {
                  const t = n.getClientRects()[0] || { width: 0, height: 0 },
                    o = e.getClientRects()[0] || { width: 0, height: 0 };
                  return o.width * o.height - t.width * t.height;
                });
              if (0 !== n.length) return n[0];
                          ...
                          !(function (n, e) {
                            document.documentElement.hasAttribute("seeking") ||
                              (function (n, e) {
                                ...
                                t &&
                                  (e.playing
                                    ? t.classList.contains("pip-play") &&
                                      (t.classList.remove("pip-play"),
                                ...
                                o &&
                                  (e.muted
                                    ? o.classList.contains("pip-unmuted") &&
                                      (o.classList.add("pip-muted"),
                                ...
                                if (r) {
                                  let n = f(e.currentTime);
                                  if (e.duration === 1 / 0) r.textContent = n;
                                  else {
                                    let t = f(e.duration);
                                    r.textContent = n + " / " + t;
                                  }
                  ...
                  (p && (a.textContent += "\n" + p),
                    ...
                    n.addEventListener("resize", (e) => {
                      !(function (n) {
                        let e = c(n),
                          t = o / r,
                          i = n.innerHeight / n.innerWidth;
                        Math.abs(t - i) < 0.005
                          ? e.classList.add("almost-perfect")
                          : e.classList.remove("almost-perfect");
                        let l = (function (n) {
                            return n.document.querySelector("#pipController");
                          })(n),
                          a = n.innerWidth;
                        ...
                        let s = n.document.querySelector(".control-group-time");
                        a <= 300
